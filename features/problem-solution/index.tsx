...
const ProblemSolution = () => {
  ...
  return (
    <div 
      ref={wrapperRef}
      className="h-[100vh] md:h-[210vh] min-h-[1000px] md:min-h-[1400px] lg:h-[1500px] w-full
    ...
    >
        ...
        <div className="relative mt-[10%] w-full h-full">
          ...
          <div className="w-full h-[100px] md:h-[300px] relative z-2">
            <ModelWrapper coinsData={problem_solution_content.coins} />
          </div>
          
        {/* Glowing Box */}
        <div className="hidden md:block mx-auto w-[100vw] md:w-[50%] h-[500px] aspect-square mt-[15%] relative z-2">
        ...
        <div className="block md:hidden mx-auto w-[100vw] md:w-[50%] h-[500px] aspect-square mt-[15%] relative z-2">
          <div className="absolute top-0 left-0 w-full h-full primary-radial-gradient-circle pulsate-primary-radial-gradient-circle opacity-30" />
          <Image 
        ...
        <div className="flex absolute bottom-[5%] md:bottom-[15%] left-0 w-full h-[150px] md:h-[400px] z-4
